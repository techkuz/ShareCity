                ...
                <div className="user-profile">
                  ...
                  <div className="user-poll-details">
                    ...
                    >
                        ...
                        <p style={pStyle}>{this.state.info.type}</p>
                        <Row>
                            <Col span={12}>
                                <DescriptionItem title="Full Name" content={this.state.info.name} />{' '}
                            </Col>
                            <Col span={12}>
                                <DescriptionItem title="Website"
                            content={(
                                <a href={this.state.info.website}>
                        ...
                        <Row>
                            <Col span={12}>
                                <DescriptionItem title="City" content={this.state.info.city} />
                            </Col>
                            <Col span={12}>
                                <DescriptionItem title="Country" content={this.state.info.country} />
                            </Col>
                        </Row>
                        <Row>
                            <Col span={12}>
    ...
    return (
        <Card style={{ width: 300, marginTop: 16 }}
            ...
            <Meta
                ...
                description={props.info.shortDescription}
            />
            </Skeleton>
        </Card>
